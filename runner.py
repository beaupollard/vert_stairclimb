...
sim_dict = {
    ...
    "step_rise_mean" : 6.85/39.37,#0.174,#0.2032,#0.2413,#0.2032,#0.1778, #0.2286
    "step_rise_std" : 0.0,
...
sim_dict["wheel_size_mean"] = 0.22#0.1778#5.5/39.37#0.265#0.1778#0.265
planet=1
dolly=1
count2=0
winch=0
outfilename='Wheeled/slope42/v1payxlocVzloc_pay40.csv'
sim_dict["step_slope_mean"] = 38.0
sim_dict["payload_zloc_mean"] = 1.0/39.37
sim_dict["payload_xloc_mean"] = -2./39.37
sim_dict["sub_wheel_size_mean"] = 4.5/39.37/2
writeout=0

filename_env='envi4.xml'
inpts=monte_sim_wheel(sim_dict,filename_env)
success_flag, contr_max = main_run(viz=True,env_name=filename_env,torque_lim=160.,planet=planet,winch=winch,kei=1.25,track=sim_dict["track"])
...
#         while moveon==False:
#             success_flag, contr_max = main_run(viz=True,env_name=env_name,torque_lim=torque_lim,planet=planet,winch=winch,kei=1.25)#0.95)
